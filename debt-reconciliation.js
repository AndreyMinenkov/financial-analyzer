...
# === ВСПОМОГАТЕЛЬНЫЕ ФУНКЦИИ (без изменений, оставляем как есть) ===
...
def index():
    ...
    return jsonify({
        'status': 'ok',
        'message': 'Сервер сверки долгов работает',
        'endpoints': {
...
if __name__ == '__main__':
    ...
    print(f"Сервер запущен на порту {port}. Для остановки нажми Ctrl+C\n")
